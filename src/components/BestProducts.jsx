...
const BestProducts = () => {
  ...
  useEffect(() => {
    const fetchBestProducts = async () => {
      const bestProducturl = await fetchBestProduct(
        "https://real-time-amazon-data.p.rapidapi.com/best-sellers?category=grocery&page=1&country=IN",
        bestProductsOptions
      );
